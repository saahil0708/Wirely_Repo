...
const Footer = () => {
  return (
    <footer className="bg-white text-black py-12 border-t font-[Poppins] mt-20 border-gray-200">
        ...
        <div className="space-y-5 text-center md:text-left">
          <div className="flex justify-center md:justify-start">
            <img 
              ...
              alt="Wirely Logo" 
              className="h-28 object-contain relative bottom-12" 
            />
          </div>
          <p className="text-gray-600 text-sm leading-relaxed bottom-20 relative">
            Connect with certified professionals instantly. Comprehensive support tailored to your unique needs.
          </p>
          <div className="flex justify-center md:justify-start relative bottom-16 space-x-4 pt-3">
