...
const CallToAction = () => {
  return (
    <section className="relative w-full overflow-hidden font-[Poppins] mt-12 bg-gray-900 px-4 py-12 flex items-center justify-center border-t border-b border-gray-800">
